...
import { AdminAuthGuardLogin, AdminAuthGuardService, BuyerAuthGuardService, SellerAuthGuardService, sellerBuyerAuthGuardLoging } from './shared/services/auth-guard.service';
...
export const routes: Routes = [
    ...
    {
        path: '', canActivate: [sellerBuyerAuthGuardLoging], children: [
